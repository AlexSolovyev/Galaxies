...
def compute_prd_for_distrs(eval_dist, ref_dist, num_angles=1001, epsilon=1e-10):
...
def _cluster_into_bins(eval_data, ref_data, num_clusters=10):
    ...
    # -- #
    ref_labels = eval_data
    eval_labels = ref_data
    # -- #
    
    num_clusters = len(set(ref_data))
...
def compute_prd(eval_data, ref_data, num_clusters=20,
    ...
    for _ in range(num_runs):
        ...
        precision, recall = compute_prd_for_distrs(eval_dist, ref_dist, num_angles)
...
def plot(precision_recall_pairs, labels=None, out_path=None,
    ...
    print(len(labels), len(precision_recall_pairs))
